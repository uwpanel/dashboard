...
! function (t, n) {
    ...
    var r = function (t) {
        ...
        w = function (t, n) {
            if (!S(t)) return t;
            var o, r;
            if (n && "function" == typeof (o = t.toString) && !S(r = o.call(t))) return r;
            if ("function" == typeof (o = t.valueOf) && !S(r = o.call(t))) return r;
            if (!n && "function" == typeof (o = t.toString) && !S(r = o.call(t))) return r;
        ...
        A = !c && !e((function () {
            return 7 != Object.defineProperty((t = "div", v ? R.createElement(t) : {}), "a", {
                get: function () {
                    return 7
                }
            }).a;
    ...
    var X, $, tt = {
            ...
            getterFor: function (t) {
                return function (n) {
                    var o;
                    if (!S(n) || (o = H(n)).type !== t) throw TypeError("Incompatible receiver, " + t + " required");
                    return o
                }
            }
        },
        ...
        at = function (t, n) {
            return arguments.length < 2 ? rt(ot[t]) || rt(a[t]) : ot[t] && ot[t][n] || a[t] && a[t][n]
        },
        et = Math.ceil,
        ct = Math.floor,
        it = function (t) {
            return isNaN(t = +t) ? 0 : (t > 0 ? ct : et)(t)
        },
        ut = Math.min,
        ft = function (t) {
            return t > 0 ? ut(it(t), 9007199254740991) : 0
        },
        lt = Math.max,
        st = Math.min,
        mt = function (t) {
            return function (n, o, r) {
                ...
                if (t && o != o) {
                    ...
                    for (; c > i; i++)
                        if ((t || i in e) && e[i] === o) return t || i || 0;
                return !t && -1
            }
        },
        gt = {
        ...
        Pt = function (t, n) {
            var o = vt[Rt(t)];
            return o == bt || o != At && ("function" == typeof n ? e(n) : !!n)
        },
        ...
        Et = !!Object.getOwnPropertySymbols && !e((function () {
        ...
        Ht = Nt ? Dt : V,
        Ft = function (t) {
            return P(yt, t) || (Et && P(Dt, t) ? yt[t] = Dt[t] : yt[t] = Ht("Symbol." + t)), yt[t]
        },
        Lt = Ft("species"),
        Bt = function (t, n) {
            var o;
            return Ot(t) && ("function" != typeof (o = t.constructor) || o !== Array && !Ot(o.prototype) ? S(o) && null === (o = o[Lt]) && (o = void 0) : o = void 0), new(void 0 === o ? Array : o)(0 === n ? 0 : n)
        },
    ...
    ! function (t, n) {
        ...
        concat: function (t) {
            ...
            for (n = -1, r = arguments.length; n < r; n++)
                if (e = -1 === n ? c : arguments[n], _t(e)) {
                    if (u + (a = ft(e.length)) > 9007199254740991) throw TypeError("Maximum allowed index exceeded");
                    for (o = 0; o < a; o++, u++) o in e && Mt(i, u, e[o])
                } else {
    ...
    }, t.extend(t.fn.bootstrapTable.defaults, t.fn.bootstrapTable.locales["ar-SA"]), t.fn.bootstrapTable.locales["ca-ES"] = {
        formatLoadingMessage: function () {
        ...
        formatShowingRows: function (t, n, o, r) {
            return void 0 !== r && r > 0 && r > o ? "Visualizzazione da ".concat(t, " a ").concat(n, " di ").concat(o, " elementi (filtered from ").concat(r, " total rows)") : "Visualizzazione da ".concat(t, " a ").concat(n, " di ").concat(o, " elementi")
        },
        formatSRPaginationPreText: function () {
            return "previous page"
        },
        ...
        formatShowingRows: function (t, n, o, r) {
            return void 0 !== r && r > 0 && r > o ? "Exibindo ".concat(t, " até ").concat(n, " de ").concat(o, " linhas (filtered from ").concat(r, " total rows)") : "Exibindo ".concat(t, " até ").concat(n, " de ").concat(o, " linhas")
        },
        formatSRPaginationPreText: function () {
            return "página anterior"
        },
