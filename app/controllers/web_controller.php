...
class WebController extends AppController
{
    ...
    public function add()
    {
        ...
        $this->ips = json_decode(implode('', $output), true);
        unset($output);
    ...
    public function edit($param_user, $param_domain)
    {
        ...
        $v_time = $data[$this->v_domain]['TIME'];
        $v_date = $data[$this->v_domain]['DATE'];
    ...
    public function suspend($param_user, $param_domain, $param_token)
    {
    ...
    public function unsuspend($param_user, $param_domain, $param_token)
    {
        error_reporting(NULL);
        ob_start();
    ...
    public function delete($param_user, $param_domain, $param_token)
    {
        error_reporting(NULL);
        ob_start();
