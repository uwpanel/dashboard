...
class TagTest extends PHPUnit\Framework\TestCase
{
    ...
    public function createTagDataProvider()
    {
        return array(
            ...
            array(
                'input',
                array('type' => 'text', 'value' => 'Hi KumbiaPHP'),
                null,
                '<input type="text" value="Hi KumbiaPHP"/>'
            ),
            array(
                'input',
                'value="Hi KumbiaPHP" type="text"',
                null,
                '<input value="Hi KumbiaPHP" type="text"/>'
            ),
            array(
                'script',
                array('type' => 'text/javascript'),
                'console.log("Hi KumbiaPHP");',
                '<script type="text/javascript">console.log("Hi KumbiaPHP");</script>',
            ),
        );
    }
